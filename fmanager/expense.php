...
if(isset($_POST['exbtn'])){
	$expAmount = trim(mysqli_real_escape_string($conn,$_POST['amt']));
	$expCategory = trim(mysqli_real_escape_string($conn,$_POST['expcat']));
	$expDay = trim(mysqli_real_escape_string($conn,$_POST['eday']));
	$expMonth = trim(mysqli_real_escape_string($conn,$_POST['emonth']));
	$expYear = trim(mysqli_real_escape_string($conn,$_POST['eyear']));
	...
	if($expAmount == "" || $expCategory == ""){
		...
		if(is_numeric($expAmount)){
			//Update database
			$q = "insert into expense (amount, category, userid, day, month, year) values('$expAmount', '$expCategory', '$userID', '$expDay', '$expMonth', '$expYear')";
			mysqli_query($conn, $q);
...
<head>
  ...
  <title>Expense - Personal Finance Manager</title>
        ...
        <div class="col-lg-8">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" method="post" action="expense.php">
                <div class="col-12">
                ...
                <div class="col-12">
                  ...
                  <input type="text" class="form-control" id="inputEmail4" name="expcat" size="50">
                </div>
                <div class="col-12">
				<table width="60%">
				<tr><td>
					...
					<div>
					  <label for="d1" class="form-label">Day</label>
					  <select name="eday" class="form-control" id="d1">
					...
					<div>
					  ...
					  <select name="emonth" class="form-control" id="d2">
					  <option>1</option><option>2</option><option>3</option><option>4</option>
					  <option>5</option><option>6</option><option>7</option><option>8</option>
					  <option>9</option><option>10</option><option>11</option><option>12</option>
					  </select>
					...
					<div>
					  ...
					  <select name="eyear" class="form-control" id="d3">
                ...
                <div class="text-center">
                  <button type="submit" class="btn btn-primary" name="exbtn">Submit</button>
                </div>
              </form>
