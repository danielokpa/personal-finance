                ...
                <div class="card-body">
				  ...
				  <?php
						...
						if(isset($_POST['loginbtn'])){
							$adminID = trim(mysqli_real_escape_string($conn,$_POST['username']));
							$admPwd = trim(mysqli_real_escape_string($conn,$_POST['pwd']));
							$q = "select recid from users where userid = '$adminID' and pwd = '$admPwd'";
